...
module pcb_support(cart_width, cart_height, cart_shell_thickness, usb_slot=false) {
    ...
    difference() {
        ...
        // pcb_cutout
        translate([cart_shell_thickness, (cart_width-pcb_support_width)/2, cart_height-pcb_support_cutout])
            cube([support_offset_2, pcb_support_width, cart_height-pcb_support_cutout]);
